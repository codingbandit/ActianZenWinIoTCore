...
{
    // The source code of this class was borrowed (and slightly modified) 
    // from: https://github.com/ms-iot/adafruitsample/blob/master/Lesson_203V2/FullSolution/BME280.cs
    ...
    public class BMP280
    {
        ...
        private async Task Begin()
        {
            ...
            CalibrationData = await ReadCoefficients();
        ...
        private async Task<BMP280_CalibrationData> ReadCoefficients()
        {
        ...
        public async Task<double> ReadPressure()
        {
            ...
            //Return the temperature as a double value
        ...
        public async Task<double> ReadAltitude(double seaLevel)
        {
            //Make sure the I2C device is initialized
            if (!init) await Begin();

            //Read the pressure first
            double pressure = await ReadPressure();
